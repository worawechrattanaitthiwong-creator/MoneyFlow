...
legacyRpc.addTransaction(token, { type:'income', amount:10000, category:'เงินเดือน', description:'ทดสอบ', date:'2026-08-20', accountId:'daily_wallet' });
legacyRpc.addTransaction(token, { type:'expense', amount:1000, category:'อาหาร', description:'ทดสอบ', date:'2026-08-20', accountId:'daily_wallet' });
